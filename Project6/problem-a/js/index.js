...
function getElementWidth(element) {
  let widthHeight = element.getBoundingClientRect();
...
*/
function renderPaletteRow(colorArray, parentElement) {
  let container = document.createElement('div');
  let parentWidth = getElementWidth(parentElement);
  let boxWidth = parentWidth / colorArray.length;
  for (let color of colorArray) {
    let box = createColorBox(color, boxWidth);
